...
<body>
	<div class="container">
		...
		<div class="text-center">
			<a href="prof_list.do" class="btn btn-primary">목록</a> <a
				href="prof_add.do" class="btn btn-info">추가</a> <a
				href="prof_edit.do?profno=${item.profno}" class="btn btn-warning">수정</a>
			<a href="prof_delete.do?profno=${item.profno}" class="btn btn-danger">삭제</a>
		</div>
		<!--// 버튼 끝 -->
	</div>
</body>
